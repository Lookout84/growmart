...
Повнофункціональний інтернет-магазин саджанців з адмін-панеллю, побудований на Python (Django), PostgreSQL, Redis та Docker.
...
- Створить бази даних
- Виконає міграції
- Завантажить категорії товарів (12 основних + підкатегорії)
